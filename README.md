...
1.**Image-based classifier** (full images)

2.**Cutout-based classifier** (background removed using segmentation masks)
...
│   ├── train.py        # Training loop (W&B integrated)
...

{
  ...
  "note": "Models disagree – possible background bias"
}
