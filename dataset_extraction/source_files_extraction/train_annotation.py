...
# Paths (update these)
# -----------------------------
RAW_JSON_FILE = Path("/Users/umaobbani/Documents/DSR_ai-ev-battery-shape-classification_portfolio/ai-ev-battery-shape-classification/zenodo_raw_files/recybat24_aug/recybat24-aug/train/annotations.json")
IMAGES_DIR = Path("/Users/umaobbani/Documents/DSR_ai-ev-battery-shape-classification_portfolio/ai-ev-battery-shape-classification/data/augumented/train/images")
ANN_DIR = Path("/Users/umaobbani/Documents/DSR_ai-ev-battery-shape-classification_portfolio/ai-ev-battery-shape-classification/data/augumented/train/annotations")
